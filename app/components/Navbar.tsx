...
export default function Navbar() {
  ...
  return (
    <nav className="w-full sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-6">
        ...
        <div className="hidden md:flex flex-1 justify-center">
          <div className="flex items-center gap-10 text-sm font-medium">
            ...
            <a href="#categorias" className="hover:text-indigo-600 transition">
              Categorías
            </a>

            <a href="#testimonios" className="hover:text-indigo-600 transition">
              Testimonios
            </a>
      ...
      {/* MOBILE MENU */}
      {open && (
        <div className="md:hidden flex flex-col bg-white border-t p-4 space-y-4">
          ...
          <Button
            variant="outline"
            className="border-indigo-600 text-indigo-600 w-full"
            onClick={() => router.push("/login")}
          >
            Iniciar sesión
          </Button>
