  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <div className="p-6 bg-white shadow rounded-xl border flex items-center gap-4">
      ...
      {/* CTA */}
      <div className="p-8 bg-indigo-50 border border-indigo-200 rounded-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-sm">
        <div>
